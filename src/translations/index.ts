...
const translations = {
  en: {
    ...
    updates: {
      ...
      admissionsTitle: "Admissions 2026–27",
      admissionsBody: "Early Years to Grade X — enquire now for the new academic year.",
      applyNow: "Enquire Now",
      summerAnnouncement: "Summer School Program",
      summerAnnouncementDate: "Enrolling now for Summer 2026",
      summerBody:
        "Strengthen foundational skills and give your child a confident headstart for the new academic year.",
      summerCta: "Enrol in Summer Program",
      admissionsAnnouncement: "Admissions Open 2026–27",
      admissionsAnnouncementDate: "Early Years to Grade X",
      admissionsPosterAlt: "Oyster School System admissions poster 2026-27",
      summerPosterAlt: "Oyster School System summer school program poster",
      updates: [],
      announcements: [],
    },
    management: {
  ...
  ur: {
    ...
    updates: {
      ...
      admissionsTitle: "داخلے ۲۰۲۶–۲۷",
      admissionsBody: "ابتدائی سالوں سے گریڈ دس تک — نئے تعلیمی سال کے لیے ابھی درخواست دیں۔",
      applyNow: "ابھی درخواست دیں",
      summerAnnouncement: "سمر اسکول پروگرام",
      summerAnnouncementDate: "سمر ۲۰۲۶ کے لیے داخلہ جاری",
      summerBody:
        "بنیادی مہارتیں مضبوط کریں اور اپنے بچے کو نئے تعلیمی سال کے لیے تیار کریں۔",
      summerCta: "سمر پروگرام میں داخلہ",
      admissionsAnnouncement: "داخلے کھلے ۲۰۲۶–۲۷",
      admissionsAnnouncementDate: "ابتدائی سالوں سے گریڈ دس",
      admissionsPosterAlt: "آئسٹر اسکول سسٹم داخلے کا پوسٹر ۲۰۲۶–۲۷",
      summerPosterAlt: "آئسٹر اسکول سسٹم سمر اسکول پروگرام پوسٹر",
      updates: [],
      announcements: [],
    },
    management: {
