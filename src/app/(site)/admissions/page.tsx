...
const ADMISSION_HIGHLIGHTS = [
  'Early Years to Grade X',
  'No admission fee for Grade VII–X',
  'No security fee for Grade VII–X',
  'Free evening tuition for Grade VII–X',
]
    ...
    <div className="min-h-screen bg-cream">
      <div className="bg-navy py-16 text-center px-4">
        ...
        <p className="font-body text-gray-300 mt-3 max-w-xl mx-auto">
          Submit an online enquiry and our team will contact you within 2 working days.
        </p>
      </div>
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            <div className="bg-white rounded-sm shadow-md border border-gray-100 overflow-hidden">
              <PosterImage
                ...
                alt="Oyster School System Admissions Open 2026-27 — Early Years to Grade X"
                className="w-full h-auto"
                priority
              />
            </div>
            <ul className="bg-white rounded-sm border border-gray-100 shadow-sm p-6 space-y-3">
              {ADMISSION_HIGHLIGHTS.map((item) => (
              ...
              >
                <div>
                  ...
                  <p className="font-body text-gray-400 text-sm mt-1">
                    Tell us about the student applying for 2026–27.
                  </p>
                </div>
            ...
            {step === 3 && (
              <div className="bg-white rounded-sm shadow-sm border border-gray-100 p-12 text-center">
                ...
                <p className="font-body text-gray-500 text-base leading-relaxed max-w-md mx-auto">
                  Thank you for your interest in Oyster School System for the 2026–27 academic year.
                  A school representative will contact you within 2 working days.
                </p>
